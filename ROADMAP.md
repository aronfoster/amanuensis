...
* [x] M18.1 Design note: define the confirmation lifecycle once — `unreviewed` →
...
* [x] M18.2 Extend `agents/revision.md`: a confirm-only invocation (human reviews an entry,
...
* [x] M18.3 Retrofit `compliance_report` Checks 3 (Canon) and 4 (Relational): when a check
...
* [x] M18.4 Retrofit `compliance_fix`'s routing so `[premise: unreviewed]` overrides the
...
* [x] M18.5 Smoke/demo coverage: a synthetic fixture exercising an unreviewed-premise finding
