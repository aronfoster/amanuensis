...
Each block follows the schema defined in `agents/storyboard-schema.md`. The prose generation workflow — how blocks are produced from the scene list and how prose is generated from a single block — is defined in `agents/drafting.md`.
