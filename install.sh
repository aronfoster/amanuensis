...
#       -> <target>/.claude/commands/revise.md
...
src_claude_revise=$script_dir/templates/dispatcher/.claude/commands/revise.md
...
dst_claude_revise=$dst_claude_dir/revise.md
...
cp "$src_claude_revise" "$dst_claude_revise"
