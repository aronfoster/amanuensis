...
Follow `AGENTS.md` first, then follow `agents/update-rules.md` and `agents/agentic-drafting.md`.
...
- Give each subagent only `agents/voice.md` and the storyboard files assigned to that scene.
